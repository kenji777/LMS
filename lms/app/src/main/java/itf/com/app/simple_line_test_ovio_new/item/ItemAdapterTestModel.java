...
import itf.com.app.simple_line_test_ovio_new.ActivityModelTestProcess;
import itf.com.app.simple_line_test_ovio_new.R;
import itf.com.app.simple_line_test_ovio_new.vo.VoTestModel;
                    ...
                    for(int i=0; i<getCount(); i++) {
                        ...
                        if(((VoTestModel) getItem(i)).getTest_model_id().equals(voTestModel.getTest_model_id())) {
                            ...
                            try {
                                ...
                                */
                                intent = new Intent(activityModelList, ActivityModelTestProcess.class);
                            }
                            catch (Exception e) {
