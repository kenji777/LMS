package itf.com.app.simple_line_test_ovio_new.item;
...
//                    Log.i(TAG, "> ItemAdapterTestItem.setTest_item_result:" + "NG");
                    holder.ll_item_wall.setBackgroundColor(context.getColor(R.color.red_06));
                    holder.tv_test_item_result.setTextColor(context.getColor(R.color.red_01));
                }
                else if(VoTestItem.getTest_item_result().equals("OK")) {
//                    Log.i(TAG, "> ItemAdapterTestItem.setTest_item_result:" + "OK");
                    holder.ll_item_wall.setBackgroundColor(context.getColor(R.color.blue_02));
                    holder.tv_test_item_result.setTextColor(context.getColor(R.color.blue_01));
                }
                else {
//                    Log.i(TAG, "> ItemAdapterTestItem.setTest_item_result:" + "OK");
                    holder.ll_item_wall.setBackgroundColor(context.getColor(R.color.white));
                    holder.tv_test_item_result.setTextColor(context.getColor(R.color.black));
                }
            }
        }
        else {
        ...
        if(VoTestItem.getTest_item_command().contains(Constants.TestItemCodes.CM0101) || VoTestItem.getTest_item_command().contains(Constants.TestItemCodes.HT0101) ||
            ...
            if(VoTestItem.getTest_item_command().contains(Constants.TestItemCodes.CM0100) || VoTestItem.getTest_item_command().contains(Constants.TestItemCodes.HT0100) ||
                ...
                if(VoTestItem.getTest_result_check_value()==null) {}
                    ...
                    holder.tv_test_item_info.setText(VoTestItem.getTest_result_check_value() + Constants.Common.LOGGER_DEVIDER_01 + VoTestItem.getTest_response_value());
                }
            }
        }
