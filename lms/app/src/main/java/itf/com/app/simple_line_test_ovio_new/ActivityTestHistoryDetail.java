...
import itf.com.app.simple_line_test_ovio_new.renderer.CustomXAxisRenderer;
import itf.com.app.simple_line_test_ovio_new.renderer.CustomYAxisRenderer;
...
import itf.com.app.simple_line_test_ovio_new.item.ItemAdapterTestDetailItem;
...
public class ActivityTestHistoryDetail extends BaseKioskActivity implements View.OnClickListener {
    ...
    private static final String TAG = "ActivityTestHistoryDetail";
    ...
    private void saveComment() {
        ...
        try {
            itf.com.app.simple_line_test_ovio_new.util.DBHelper helper = 
                new itf.com.app.simple_line_test_ovio_new.util.DBHelper(this, "itf_temperature_table.db", null, 2);
