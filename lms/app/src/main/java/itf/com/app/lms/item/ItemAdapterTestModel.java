...
// MEMORY LEAK FIX: Removed static Context and SharedPreferences imports
// import static itf.com.app.simple_line_test_ovio_new.ActivityModelList.activityModelList;
...
//            LinearLayout ll_model_list_item = convertView.findViewById(R.id.ll_model_list_item);
            ...
            convertView.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                        ...
                        if(((VoTestModel) getItem(i)).getTest_model_id().equals(voTestModel.getTest_model_id())) {
                            ...
                            try {
                                ...
                                if(voTestModel.getTest_model_id().equals("00000001")) {
                                    intent = new Intent(context, ActivityModel_0001.class);
                                }
                                else if(voTestModel.getTest_model_id().equals("00000002")) {
                                    intent = new Intent(context, ActivityModel_0002.class);
                                }
                                else if(voTestModel.getTest_model_id().equals("00000003")) {
                                    intent = new Intent(context, ActivityModel_0003.class);
                                }
                                */
                                intent = new Intent(context, ActivityModelTestProcess.class);
                            }
                            catch (Exception e) {
                    ...
                    // MEMORY LEAK FIX: Use local SharedPreferences with immediate apply() instead of static references
                    SharedPreferences preferences = context.getSharedPreferences("test_cookie_info", MODE_PRIVATE);
                    preferences.edit()
                        .putString("test_model_id", voTestModel.getTest_model_id())
                        .putString("test_model_name", voTestModel.getTest_model_name())
                        .putString("test_model_nation", voTestModel.getTest_model_nationality_name())
                        .apply();
            ...
            convertView.setOnTouchListener(new View.OnTouchListener() {
                ...
                public boolean onTouch(View v, MotionEvent event) {
                    ...
                    if (event.getAction() == MotionEvent.ACTION_DOWN) {
                        color = context.getColor(R.color.red_06);
                    }
